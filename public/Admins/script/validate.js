!(function(t, e) {
    "object" == typeof exports && "object" == typeof module ?
        ...
        (exports.bootstrapValidate = e()) :
        (t.bootstrapValidate = e());
})(this, function() {
    return (function(t) {
        var e = {};
        ...
        function(t, e, n) {
            ...
            (t.exports = function(t, e, n) {
                (0, o.default)([t]).forEach(function(t) {
                    (t = t.nodeType ? t : document.querySelector(t)).addEventListener(
                        f.LISTENER,
                        function() {
            ...
            (t.exports = {
                ...
                divisible: function(t, e) {
                    ...
                    return (
                        ...
                        (n =
                            "0" ===
                            new d.default(o).mod(new d.default(Number(e))).toString()),
                        n
                    );
                },
                ...
                matches: function(t, e) {
                    var n = e;
                    return (
                        void 0 === n.nodeType && (n = document.querySelector(e)),
                        t.value === n.value
                    );
                },
                alpha: function(t) {
                    return (
                        (0, i.default)(t.value) && new RegExp(/^[a-z]+$/i).test(t.value)
                    );
                },
                inArray: function(t, e) {
                    var n = (0, s.default)(t.value);
                    return (-1 !==
                        (0, a.default)((0, s.default)(e, "whitespace()"), ",").indexOf(n)
                    );
                }
            }),
            (e.default = t.exports);
        ...
        function(t, e, n) {
            ...
            t.exports = function(t, e, n) {
                return (
                    n && "number" != typeof n && i(t, e, n) && (e = n = void 0),
                    (n = void 0 === n ? a : n >>> 0) ?
                    (t = s(t)) &&
            ...
            !(function(o) {
                ...
                function b(t, e, n, r) {
                    ...
                    if (u < o.length) {
                        if (1 === n) r = o[u] >= 5;
                            ...
                            r =
                            o[u] > 5 ||
                            (5 == o[u] && (r || u < 0 || o[u + 1] !== g || 1 & o[u - 1]));
                        else if (3 === n) r = r || !!o[0];
                        else if (((r = !1), 0 !== n)) throw Error(v);
                        if (u < 1)
                            (o.length = 1), r ? ((t.e = -e), (o[0] = 1)) : (o[0] = t.e = 0);
                        else {
                            if (((o.length = u--), r))
                ...
                function y(t, e, n, r) {
                    ...
                    if (n !== g) {
                        ...
                        for (
                            n = r - (t = new i(t)).e,
                            t.c.length > ++r && b(t, n, i.RM),
                            2 == e && (r = t.e + n + 1); t.c.length < r;
                ...
                (h.div = function(t) {
                    ...
                    do {
                        ...
                        (w[j++] = l ? a : ++a),
                        y[0] && l ? (y[m] = r[h] || 0) : (y = [r[h]]);
                    } while ((h++ < x || y[0] !== g) && u--);
                    return (
                        w[0] || 1 == j || (w.shift(), E.e--),
                        j > O && b(E, i, n.RM, y[0] !== g),
                        E
                    );
                }),
                (h.eq = function(t) {
                ...
                (h.minus = h.sub = function(t) {
                    ...
                    var s = u.c.slice(),
                        ...
                        p = t.e;
                    if (!s[0] || !l[0])
                        return l[0] ? ((t.s = -c), t) : new i(s[0] ? u : 0);
                    if ((f = a - p)) {
                        for (
                            (o = f < 0) ? ((f = -f), (r = s)) : ((p = a), (r = l)),
                            r.reverse(),
                            c = f; c--;
                        ...
                        for (
                            n = ((o = s.length < l.length) ? s : l).length, f = c = 0; c < n; c++
                        )
                            if (s[c] != l[c]) {
                                o = s[c] < l[c];
                                break;
                ...
                (h.plus = h.add = function(t) {
                    ...
                    if (((f = f.slice()), (o = i - c))) {
                        for (
                            o > 0 ? ((c = i), (e = s)) : ((o = -o), (e = f)), e.reverse(); o--;
                    ...
                    for (
                        f.length - s.length < 0 && ((e = s), (s = f), (f = e)),
                        o = s.length,
                        u = 0; o; f[o] %= 10
                    )
                        u = ((f[--o] = f[o] + s[o] + u) / 10) | 0;
                    for (u && (f.unshift(u), ++c), o = f.length; 0 === f[--o];)
                        f.pop();
                ...
                (h.sqrt = function() {
                    ...
                    0 === (u = Math.sqrt(r + "")) || u === 1 / 0 ?
                        (((e = r.c.join("")).length + i) & 1 || (e += "0"),
                            (i = (((i + 1) / 2) | 0) - (i < 0 || 1 & i)),
                            (t = new o(
                                ((u = Math.sqrt(e)) == 1 / 0 ?
                                    "1e" :
                                    (u = u.toExponential()).slice(0, u.indexOf("e") + 1)) + i
                            ))) :
                        (t = new o(u)),
                        (i = t.e + (o.DP += 4));
                    do {
                ...
                (h.times = h.mul = function(t) {
                    var e,
                        ...
                        c = n.e,
                        s = t.e;
                    if (((t.s = n.s == t.s ? 1 : -1), !o[0] || !u[0]))
                        return new r(0 * t.s);
                    for (
                        t.e = c + s,
                        i < f && ((e = o), (o = u), (u = e), (s = i), (i = f), (f = s)),
                        e = new Array((s = i + f)); s--;
        ...
        function(t, e, n) {
            ...
            (t.exports = function(t, e, n, o) {
                ...
                n
                    ?
                    i && (t.classList.remove(r.CLASS_ERROR), (i.style.display = "none")) :
                    (i ?
                        ((i.innerHTML = o), (i.style.display = "inline-block")) :
                        ((i = document.createElement(r.ELEMENT_HELP_BLOCK)),
                            t.parentNode.appendChild(i),
                            (i.style.display = "inline-block"),
                            i.classList.add(r.CLASS_HELP_BLOCK, u),
                            (i.innerHTML = o)),
                        t.classList.contains(r.CLASS_ERROR) ||
                        t.classList.add(r.CLASS_ERROR));
            }),
            (e.default = t.exports);
        }
    ]);
